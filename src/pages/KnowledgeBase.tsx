...
export const KnowledgeBase: React.FC<KnowledgeBaseProps> = ({
  ...
  const handleFileUpload = async (file: File, categoryId: string, title: string, description?: string) => {
    try {
  ...
  return <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 mb-2 text-left">Knowledge Base</h1>
      ...
      <div className="grid grid-cols-4 gap-6 mb-8">
        ...
        return <div key={stat.label} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        ...
        <div className="flex gap-4">
          <div className="flex-1">
            <div className="relative">
              ...
              <Input placeholder="Search knowledge base..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pl-10 border-slate-200 focus:border-blue-500 focus:ring-blue-500" />
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            <CategorySidebar categories={categories} selectedCategory={selectedCategory} onCategorySelect={setSelectedCategory} itemCounts={knowledgeItems.reduce((acc, item) => {
        ...
        <div className="lg:col-span-3">
          <KnowledgeItemsGrid items={filteredItems} loading={loading} viewMode={viewMode} onItemUpdate={loadKnowledgeItems} onViewFile={onViewFile} />
        </div>
      </div>

      <FileUploadDialog open={showUploadDialog} onOpenChange={setShowUploadDialog} categories={categories} onUpload={handleFileUpload} />
    </div>;
};
